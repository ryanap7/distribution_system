...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Kecamatan -->
            <li class="nav-item {{ Nav::isRoute('districts.index') }}">
            ...
            <!-- Nav Item - Desa -->
            <li class="nav-item {{ Nav::isRoute('villages.index') }}">
            ...
            <!-- Nav Item - Penerima -->
            <li class="nav-item {{ Nav::isRoute('recipients.index') }}">
                <a class="nav-link" href="{{ route('recipients.index') }}">
                    <i class="fas fa-fw fa-user"></i>
                    <span>{{ __('Penerima') }}</span>
                </a>
            </li>
